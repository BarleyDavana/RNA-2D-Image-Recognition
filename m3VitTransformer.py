...
class DecoderLayer(nn.Module):
    def __init__(self, embed_dim, dropout, n_heads):
        ...
        self.dec_enc_attn = Multi_Head_Attention(Q_dim=embed_dim, K_dim=768, QKVdim=64, n_heads=n_heads, dropout=dropout)
        self.pos_ffn = PoswiseFeedForwardNet(embed_dim=embed_dim, d_ff=768, dropout=dropout)
